...
// Route .
func (s *UsersService) Route(ctx context.Context, routeID int64) (*gj.FeatureCollection, error) {
...
// Trip .
func (s *UsersService) Trip(ctx context.Context, tripID int64) (*gj.FeatureCollection, error) {
