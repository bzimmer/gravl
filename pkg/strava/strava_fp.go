...
func MapRoute(f func(Route) Route, list []Route) []Route {
	if f == nil {
		return []Route{}
	}
	newList := make([]Route, len(list))
	for i, v := range list {
		newList[i] = f(v)
	}
	return newList
...
func MapRoutePtr(f func(*Route) *Route, list []*Route) []*Route {
	if f == nil {
		return []*Route{}
	}
	newList := make([]*Route, len(list))
...
// MapRoutePtrErr takes 2 arguments:
//  1. A function input argument: *Route and return types (*Route, error)
//  2. A list of type []*Route
//
// Returns:
// 	([]*Route, error)
func MapRoutePtrErr(f func(*Route) (*Route, error), list []*Route) ([]*Route, error) {
	if f == nil {
		return []*Route{}, nil
	}
	newList := make([]*Route, len(list))
...
// MapRouteErr takes 2 arguments:
//  1. A function input argument: Route and return types (Route, error)
//  2. A list of type []Route
//
// Returns:
// 	([]Route, error)
func MapRouteErr(f func(Route) (Route, error), list []Route) ([]Route, error) {
	if f == nil {
		return []Route{}, nil
	}
	newList := make([]Route, len(list))
...
func FilterRoute(f func(Route) bool, list []Route) []Route {
	if f == nil {
		return []Route{}
	}
	var newList []Route
...
func FilterRoutePtr(f func(*Route) bool, list []*Route) []*Route {
	if f == nil {
		return []*Route{}
	}
	var newList []*Route
...
// FilterRoutePtrErr takes two arguments
//  1. Function: takes 1 argument of type Route and returns (bool, error)
//  2. slice of type []*Route
//
// Returns:
//  new filtered list and error
func FilterRoutePtrErr(f func(*Route) (bool, error), list []*Route) ([]*Route, error) {
	if f == nil {
		return []*Route{}, nil
	}
	var newList []*Route
...
// FilterRouteErr takes two arguments
//  1. Function: takes 1 argument of type Route and returns (bool, error)
//  2. slice of type []Route
//
// Returns:
//  new filtered list and error
func FilterRouteErr(f func(Route) (bool, error), list []Route) ([]Route, error) {
	if f == nil {
		return []Route{}, nil
	}
	var newList []Route
...
func RemoveRoute(f func(Route) bool, list []Route) []Route {
	if f == nil {
		return []Route{}
	}
	var newList []Route
...
func RemoveRoutePtr(f func(*Route) bool, list []*Route) []*Route {
	if f == nil {
		return []*Route{}
	}
	var newList []*Route
...
// RemoveRoutePtrErr removes the items from the given list based on supplied function and returns new list
//
// Takes 2 inputs:
//	1. Function: input type *Route and return types(bool, error)
//	2. List of type: []*Route
//
// Returns:
//	New list and error: ([]*Route, error)
//	Empty list if both of arguments are nil or either one is nil.
func RemoveRoutePtrErr(f func(*Route) (bool, error), list []*Route) ([]*Route, error) {
	if f == nil {
		return []*Route{}, nil
	}
	var newList []*Route
...
// RemoveRouteErr removes the items from the given list based on supplied function and returns new list
//
// Takes 2 inputs:
//	1. Function: input type Route and return types(bool, error)
//	2. List of type: []Route
...
//	New list and error: ([]Route, error)
//	Empty list if both of arguments are nil or either one is nil.
func RemoveRouteErr(f func(Route) (bool, error), list []Route) ([]Route, error) {
	if f == nil {
		return []Route{}, nil
	}
	var newList []Route
...
func SomeRoute(f func(Route) bool, list []Route) bool {
	if f == nil {
		return false
	}
	for _, v := range list {
...
func SomeRoutePtr(f func(*Route) bool, list []*Route) bool {
	if f == nil {
		return false
	}
	for _, v := range list {
...
// SomeRoutePtrErr finds item in the list based on supplied function.
//
// Takes 2 input:
//	1. Function
//	2. List
...
//	(bool,err).
//	True if condition satisfies, else false
func SomeRoutePtrErr(f func(*Route) (bool, error), list []*Route) (bool, error) {
	if f == nil {
		return false, nil
	}
	for _, v := range list {
...
// SomeRouteErr finds item in the list based on supplied function.
//
// Takes 2 input:
//	1. Function
//	2. List
...
//	(bool,err).
//	True if condition satisfies, else false
func SomeRouteErr(f func(Route) (bool, error), list []Route) (bool, error) {
	if f == nil {
		return false, nil
	}
	for _, v := range list {
...
func EveryRoute(f func(Route) bool, list []Route) bool {
	if f == nil || len(list) == 0 {
		return false
	}
	for _, v := range list {
...
func EveryRoutePtr(f func(*Route) bool, list []*Route) bool {
	if f == nil || len(list) == 0 {
		return false
	}
	for _, v := range list {
...
// EveryRoutePtrErr returns true if supplied function returns logical true for every item in the list
func EveryRoutePtrErr(f func(*Route) (bool, error), list []*Route) (bool, error) {
	if f == nil || len(list) == 0 {
		return false, nil
	}
	for _, v := range list {
...
// EveryRouteErr returns true if supplied function returns logical true for every item in the list
func EveryRouteErr(f func(Route) (bool, error), list []Route) (bool, error) {
	if f == nil || len(list) == 0 {
		return false, nil
	}
	for _, v := range list {
...
func DropWhileRoute(f func(Route) bool, list []Route) []Route {
	if f == nil {
		return []Route{}
	}
	var newList []Route
...
func DropWhileRoutePtr(f func(*Route) bool, list []*Route) []*Route {
	if f == nil {
		return []*Route{}
	}
	var newList []*Route
...
// DropWhileRoutePtrErr drops the items from the list as long as condition satisfies.
//
// Takes two inputs
//	1. Function: takes one input and returns (boolean, error)
//	2. list
...
// 	New List, error
//  Empty list if either one of arguments or both of them are nil
func DropWhileRoutePtrErr(f func(*Route) (bool, error), list []*Route) ([]*Route, error) {
	if f == nil {
		return []*Route{}, nil
	}
	var newList []*Route
...
// DropWhileRouteErr drops the items from the list as long as condition satisfies.
//
// Takes two inputs
//	1. Function: takes one input and returns (boolean, error)
//	2. list
...
// 	New List, error
//  Empty list if either one of arguments or both of them are nil
func DropWhileRouteErr(f func(Route) (bool, error), list []Route) ([]Route, error) {
	if f == nil {
		return []Route{}, nil
	}
	var newList []Route
...
func TakeWhileRoute(f func(Route) bool, list []Route) []Route {
	if f == nil {
		return []Route{}
	}
	var newList []Route
...
func TakeWhileRoutePtr(f func(*Route) bool, list []*Route) []*Route {
	if f == nil {
		return []*Route{}
	}
	var newList []*Route
...
// TakeWhileRoutePtrErr returns new list based on condition in the supplied function. It returns new list once condition fails.
//
// Takes 2 inputs:
//	1. Function - 1 input of type *Route and returns ([]*Route, error)
//	2. List
//
// Returns:
//	New List, error.
//	Empty list if all the parameters are nil or either of one parameter is nil
func TakeWhileRoutePtrErr(f func(*Route) (bool, error), list []*Route) ([]*Route, error) {
	if f == nil {
		return []*Route{}, nil
	}
	var newList []*Route
...
// TakeWhileRouteErr returns new list based on condition in the supplied function. It returns new list once condition fails.
//
// Takes 2 inputs:
//	1. Function - 1 input of type Route and returns ([]Route, error)
//	2. List
...
//	New List, error.
//	Empty list if all the parameters are nil or either of one parameter is nil
func TakeWhileRouteErr(f func(Route) (bool, error), list []Route) ([]Route, error) {
	if f == nil {
		return []Route{}, nil
	}
	var newList []Route
...
// PMapRoute applies the function(1st argument) on each item in the list and returns a new list.
//  Order of new list is guaranteed. This feature can be disabled by passing: Optional{RandomOrder: true} to gain performance
//  Run in parallel. no_of_goroutines = no_of_items_in_list or 3rd argument can be passed to fix the number of goroutines.
//
// Takes 3 inputs. 3rd argument is optional
...
//  2. List
//  3. optional argument - fp.Optional{FixedPool: <some_number>}
func PMapRoute(f func(Route) Route, list []Route, optional ...fp.Optional) []Route {
	if f == nil {
		return []Route{}
	}
	...
	if optional != nil && len(optional) > 0 {
		...
		if optional[0].RandomOrder == true {
			return pMapRouteNoOrder(f, list, worker)
		}
	}

	return pMapRoutePreserveOrder(f, list, worker)
}

func pMapRoutePreserveOrder(f func(Route) Route, list []Route, worker int) []Route {
	chJobs := make(chan map[int]Route, len(list))
	go func() {
		for i, v := range list {
			chJobs <- map[int]Route{i: v}
		}
		close(chJobs)
	}()

	chResult := make(chan map[int]Route, worker/3)
	...
	for i := 0; i < worker; i++ {
		...
		go func(chResult chan map[int]Route, chJobs chan map[int]Route) {
			defer wg.Done()

			for m := range chJobs {
				for k, v := range m {
					chResult <- map[int]Route{k: f(v)}
				}
			}
		}(chResult, chJobs)
	}
	...
	newListMap := make(map[int]Route, len(list))
	newList := make([]Route, len(list))
...
func pMapRouteNoOrder(f func(Route) Route, list []Route, worker int) []Route {
	chJobs := make(chan Route, len(list))
	go func() {
		for _, v := range list {
			chJobs <- v
		}
	...
	chResult := make(chan Route, worker/3)
	...
	for i := 0; i < worker; i++ {
		...
		go func(chResult chan Route, chJobs chan Route) {
			defer wg.Done()
...
// PMapRoutePtr applies the function(1st argument) on each item in the list and returns a new list.
//  Order of new list is guaranteed. This feature can be disabled by passing: Optional{RandomOrder: true} to gain performance
//  Run in parallel. no_of_goroutines = no_of_items_in_list or 3rd argument can be passed to fix the number of goroutines.
//
// Takes 3 inputs. 3rd argument is optional
...
//  2. List
//  3. optional argument - fp.Optional{FixedPool: <some_number>}
func PMapRoutePtr(f func(*Route) *Route, list []*Route, optional ...fp.Optional) []*Route {
	if f == nil {
		return []*Route{}
	}
	...
	if optional != nil && len(optional) > 0 {
		...
		if optional[0].RandomOrder == true {
			return pMapRoutePtrNoOrder(f, list, worker)
		}
	}

	return pMapRoutePtrPreserveOrder(f, list, worker)
}

func pMapRoutePtrPreserveOrder(f func(*Route) *Route, list []*Route, worker int) []*Route {
	chJobs := make(chan map[int]*Route, len(list))
	go func() {
		for i, v := range list {
			chJobs <- map[int]*Route{i: v}
...
func pMapRoutePtrNoOrder(f func(*Route) *Route, list []*Route, worker int) []*Route {
	chJobs := make(chan *Route, len(list))
	go func() {
		for _, v := range list {
			chJobs <- v
...
// PMapRoutePtrErr applies the function(1st argument) on each item in the list and returns a new list and error.
//  Order of new list is guaranteed. This feature can be disabled by passing: Optional{RandomOrder: true} to gain performance
//  Run in parallel. no_of_goroutines = no_of_items_in_list or 3rd argument can be passed to fix the number of goroutines.
//
// Takes 3 inputs. 3rd argument is optional
...
//  2. List
//  3. optional argument - fp.Optional{FixedPool: <some_number>}
func PMapRoutePtrErr(f func(*Route) (*Route, error), list []*Route, optional ...fp.Optional) ([]*Route, error) {
	if f == nil {
		return []*Route{}, nil
	}
	...
	if optional != nil && len(optional) > 0 {
		...
		if optional[0].RandomOrder == true {
			return pMapRoutePtrErrNoOrder(f, list, worker)
		}
	}

	return pMapRoutePtrErrPreserveOrder(f, list, worker)
}

func pMapRoutePtrErrPreserveOrder(f func(*Route) (*Route, error), list []*Route, worker int) ([]*Route, error) {
	chJobs := make(chan map[int]*Route, len(list))
	go func() {
		for i, v := range list {
			chJobs <- map[int]*Route{i: v}
	...
	for i := 0; i < worker; i++ {
		...
		go func(chResult chan map[int]*Route, chJobs chan map[int]*Route, errCh chan error) {
			defer wg.Done()
			if len(errCh) > 0 {
				return
			}
...
func pMapRoutePtrErrNoOrder(f func(*Route) (*Route, error), list []*Route, worker int) ([]*Route, error) {
	chJobs := make(chan *Route, len(list))
	go func() {
		for _, v := range list {
			chJobs <- v
	...
	for i := 0; i < worker; i++ {
		...
		go func(chResult chan *Route, chJobs chan *Route, errCh chan error) {
			defer wg.Done()
			if len(errCh) > 0 {
				return
			}
...
// PMapRouteErr applies the function(1st argument) on each item in the list and returns a new list and error.
//  Order of new list is guaranteed. This feature can be disabled by passing: Optional{RandomOrder: true} to gain performance
//  Run in parallel. no_of_goroutines = no_of_items_in_list or 3rd argument can be passed to fix the number of goroutines.
//
// Takes 3 inputs. 3rd argument is optional
...
//  2. List
//  3. optional argument - fp.Optional{FixedPool: <some_number>}
func PMapRouteErr(f func(Route) (Route, error), list []Route, optional ...fp.Optional) ([]Route, error) {
	if f == nil {
		return []Route{}, nil
	}
	...
	if optional != nil && len(optional) > 0 {
		...
		if optional[0].RandomOrder == true {
			return pMapRouteErrNoOrder(f, list, worker)
		}
	}

	return pMapRouteErrPreserveOrder(f, list, worker)
}

func pMapRouteErrPreserveOrder(f func(Route) (Route, error), list []Route, worker int) ([]Route, error) {
	chJobs := make(chan map[int]Route, len(list))
	go func() {
		for i, v := range list {
			chJobs <- map[int]Route{i: v}
...
func pMapRouteErrNoOrder(f func(Route) (Route, error), list []Route, worker int) ([]Route, error) {
	chJobs := make(chan Route, len(list))
	go func() {
		for _, v := range list {
			chJobs <- v
...
func FilterMapRoute(fFilter func(Route) bool, fMap func(Route) Route, list []Route) []Route {
	if fFilter == nil || fMap == nil {
		return []Route{}
	}
	var newList []Route
...
func FilterMapRoutePtr(fFilter func(*Route) bool, fMap func(*Route) *Route, list []*Route) []*Route {
	if fFilter == nil || fMap == nil {
		return []*Route{}
	}
	var newList []*Route
...
// FilterMapRoutePtrErr filters given list, then apply function(2nd argument) on each item in the list and returns a new list
// Takes 3 inputs
//	1. Function: takes one input(*Route) and returns (bool, error).
//	2. Function: takes *Route as argument and returns (*Route, error)
// 	3. Slice of type []*Route
//
// Returns:
//	New List ([]*Route, error).
//  Empty list if all there parameters are nil or either of parameter is nil
func FilterMapRoutePtrErr(fFilter func(*Route) (bool, error), fMap func(*Route) (*Route, error), list []*Route) ([]*Route, error) {
	if fFilter == nil || fMap == nil {
		return []*Route{}, nil
	}
	var newList []*Route
...
// FilterMapRouteErr filters given list, then apply function(2nd argument) on each item in the list and returns a new list
// Takes 3 inputs
//	1. Function: takes one input(Route) and returns (bool, error).
//	2. Function: takes Route as argument and returns (Route, error)
// 	3. Slice of type []Route
...
//  Empty list if all there parameters are nil or either of parameter is nil
//
func FilterMapRouteErr(fFilter func(Route) (bool, error), fMap func(Route) (Route, error), list []Route) ([]Route, error) {
	if fFilter == nil || fMap == nil {
		return []Route{}, nil
	}
	var newList []Route
...
// RestRoute removes 1st item of the list and return new list having rest of the items
func RestRoutePtr(l []*Route) []*Route {
	if l == nil {
		return []*Route{}
	}
...
func ReduceRoute(f func(Route, Route) Route, list []Route, initializer ...Route) Route {
	var init Route 
	lenList := len(list)
	...
	r := f(init, list[0])
	return ReduceRoute(f, list[1:], r)
}

func ReduceRoutePtr(f func(*Route, *Route) *Route, list []*Route, initializer ...Route) *Route {
	var initVal Route
	var init *Route = &initVal
	lenList := len(list)
	...
	r := f(init, list[0])
	return ReduceRoutePtr(f, list[1:], *r)
}

// ReduceRoutePtrErr reduces a list to a single value by combining elements via a supplied function
//
// Takes three inputs
//	A. function - takes two arguments (*Route, *Route)
//	B. list of type []*Route
// 	C. initializer (optional of type Route)
//
// Returns:
//	single value, error: (*Route, error)
func ReduceRoutePtrErr(f func(*Route, *Route) (*Route, error), list []*Route, initializer ...Route) (*Route, error) {
	var initVal Route
	var init *Route = &initVal
	lenList := len(list)
	...
	return ReduceRoutePtrErr(f, list[1:], *r)
}

// ReduceRouteErr reduces a list to a single value by combining elements via a supplied function
//
// Takes three inputs
//	A. function - takes two arguments (Route, Route)
//	B. list of type []Route
...
// Returns:
//	single value, error: (Route, error)
func ReduceRouteErr(f func(Route, Route) (Route, error), list []Route, initializer ...Route) (Route, error) {
	var initVal Route
	var init Route = initVal
	lenList := len(list)
	...
	return ReduceRouteErr(f, list[1:], r)
}

// DropLastRoute drops last item from the list and returns new list.
// Returns empty list if there is only one item in the list or list empty
func DropLastRoute(list []Route) []Route {
	listLen := len(list)
...
// DropLastRoutePtr drops last item from the list and returns new list.
// Returns empty list if there is only one item in the list or list empty
func DropLastRoutePtr(list []*Route) []*Route {
	listLen := len(list)
...
// ReverseRoutes reverse the list
func ReverseRoutes(list []Route) []Route {
	newList := make([]Route, len(list))
	for i := 0; i < len(list); i++ {
		newList[i] = list[len(list)-(i+1)]
	}
...
// ReverseRoutesPtr reverse the list
func ReverseRoutesPtr(list []*Route) []*Route {
	newList := make([]*Route, len(list))
	for i := 0; i < len(list); i++ {
		newList[i] = list[len(list)-(i+1)]
	}
...
// TakeRoute returns n items in the list
func TakeRoute(n int, list []Route) []Route {
	if n < 0 {
		return []Route{}
	}
...
// TakeRoutePtr returns n items in the list
func TakeRoutePtr(n int, list []*Route) []*Route {
	if n < 0 {
		return []*Route{}
	}
...
// DistinctRouteP returns true if no two of the arguments are =
func DistinctRouteP(list []Route) bool {
	if len(list) == 0 {
		return false
	}
...
// DistinctRoutePPtr returns true if no two of the arguments are =
func DistinctRoutePPtr(list []*Route) bool {
	if len(list) == 0 {
		return false
	}
...
// DistinctRoute removes duplicates.
func DistinctRoute(list []Route) []Route {
	if len(list) == 0 {
		return []Route{}
	}

	newList := []Route{list[0]}
...
func DistinctRoutePtr(list []*Route) []*Route {
	if len(list) == 0 {
		return []*Route{}
	}
...
// UnionRoute return a set that is the union of the input sets
// repeated value within list parameter will be ignored
func UnionRoute(arrList ...[]Route) []Route {
	var newList []Route
...
// UnionRoutePtr return a set that is the union of the input sets
// repeated value within list parameter will be ignored
func UnionRoutePtr(arrList ...[]*Route) []*Route {
	var newList []*Route
...
// IntersectionRoute return a set that is the intersection of the input sets
// repeated value within list parameter will be ignored
func IntersectionRoute(arrList ...[]Route) []Route {
	if arrList == nil {
		return []Route{}
	}
...
// IntersectionRoutePtr return a set that is the intersection of the input sets
// repeated value within list parameter will be ignored
func IntersectionRoutePtr(arrList ...[]*Route) []*Route {
	if arrList == nil {
		return []*Route{}
	}
...
// DifferenceRoute returns a set that is the first set without elements of the remaining sets
// repeated value within list parameter will be ignored
func DifferenceRoute(arrList ...[]Route) []Route {
	if arrList == nil {
		return []Route{}
	}
...
// DifferenceRoutePtr returns a set that is the first set without elements of the remaining sets
// repeated value within list parameter will be ignored
func DifferenceRoutePtr(arrList ...[]*Route) []*Route {
	if arrList == nil {
		return []*Route{}
	}
...
// SubsetRoute returns true or false by checking if set1 is a subset of set2
// repeated value within list parameter will be ignored, order does not matter
func SubsetRoute(list1, list2 []Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SubsetRoutePtr returns true or false by checking if set1 is a subset of set2
// repeated value within list parameter will be ignored, order does not matter
func SubsetRoutePtr(list1, list2 []*Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SupersetRoute returns true or false by checking if set1 is a superset of set2
// repeated value within list parameter will be ignored, order does not matter
func SupersetRoute(list1, list2 []Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SupersetRoutePtr returns true or false by checking if set1 is a superset of set2
// repeated value within list parameter will be ignored, order does not matter
func SupersetRoutePtr(list1, list2 []*Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SetRoute returns a set of the distinct elements of coll.
func SetRoute(list []Route) []Route {
	if len(list) == 0 {
		return []Route{}
	}
...
// SetRoutePtr returns a set of the distinct elements of coll.
func SetRoutePtr(list []*Route) []*Route {
	if len(list) == 0 {
		return []*Route{}
	}
...
// MapActivityRouteErr takes two inputs -
// 1. Function 2. List. Then It returns a new list after applying the function on each item of the list and error
func MapActivityRouteErr(f func(Activity) (Route, error), list []Activity) ([]Route, error) {
	if f == nil {
		return []Route{}, nil
	}
	newList := make([]Route, len(list))
...
// MapActivityRoutePtr takes two inputs -
// 1. Function 2. List. Then It returns a new list after applying the function on each item of the list
func MapActivityRoutePtr(f func(*Activity) *Route, list []*Activity) []*Route {
	if f == nil {
		return []*Route{}
	}
	newList := make([]*Route, len(list))
...
// MapActivityRoutePtrErr takes two inputs -
// 1. Function 2. List. Then It returns a new list after applying the function on each item of the list, error
func MapActivityRoutePtrErr(f func(*Activity) (*Route, error), list []*Activity) ([]*Route, error) {
	if f == nil {
		return []*Route{}, nil
	}
	newList := make([]*Route, len(list))
...
// PMapActivityRoute applies the function(1st argument) on each item in the list and returns a new list.
//  Order of new list is guaranteed. This feature can be disabled by passing: Optional{RandomOrder: true} to gain performance
//  Run in parallel. no_of_goroutines = no_of_items_in_list or 3rd argument can be passed to fix the number of goroutines.
//
// Takes 3 inputs. 3rd argument is optional
...
//  2. List
//  3. optional argument - fp.Optional{FixedPool: <some_number>}
func PMapActivityRoute(f func(Activity) Route, list []Activity, optional ...fp.Optional) []Route {
	if f == nil {
		return []Route{}
	}
	...
	if optional != nil && len(optional) > 0 {
		...
		if optional[0].RandomOrder == true {
			return pMapActivityRouteNoOrder(f, list, worker)
		}
	}

	return pMapActivityRoutePreserveOrder(f, list, worker)
}

func pMapActivityRoutePreserveOrder(f func(Activity) Route, list []Activity, worker int) []Route {
	chJobs := make(chan map[int]Activity, len(list))
	go func() {
		for i, v := range list {
			chJobs <- map[int]Activity{i: v}
	...
	for i := 0; i < worker; i++ {
		...
		go func(chResult chan map[int]Route, chJobs chan map[int]Activity) {
			defer wg.Done()
...
func pMapActivityRouteNoOrder(f func(Activity) Route, list []Activity, worker int) []Route {
	chJobs := make(chan Activity, len(list))
	go func() {
		for _, v := range list {
			chJobs <- v
	...
	for i := 0; i < worker; i++ {
		...
		go func(chResult chan Route, chJobs chan Activity) {
			defer wg.Done()
...
// PMapActivityRouteErr applies the function(1st argument) on each item in the list and returns a new list and error.
//  Order of new list is guaranteed. This feature can be disabled by passing: Optional{RandomOrder: true} to gain performance
//  Run in parallel. no_of_goroutines = no_of_items_in_list or 3rd argument can be passed to fix the number of goroutines.
//
// Takes 3 inputs. 3rd argument is optional
...
//  2. List
//  3. optional argument - fp.Optional{FixedPool: <some_number>}
func PMapActivityRouteErr(f func(Activity) (Route, error), list []Activity, optional ...fp.Optional) ([]Route, error) {
	if f == nil {
		return []Route{}, nil
	}
	...
	if optional != nil && len(optional) > 0 {
		...
		if optional[0].RandomOrder == true {
			return pMapActivityRouteErrNoOrder(f, list, worker)
		}
	}

	return pMapActivityRouteErrPreserveOrder(f, list, worker)
}

func pMapActivityRouteErrPreserveOrder(f func(Activity) (Route, error), list []Activity, worker int) ([]Route, error) {
	chJobs := make(chan map[int]Activity, len(list))
	go func() {
		for i, v := range list {
			chJobs <- map[int]Activity{i: v}
	...
	for i := 0; i < worker; i++ {
		...
		go func(chResult chan map[int]Route, chJobs chan map[int]Activity, errCh chan error) {
			defer wg.Done()
			if len(errCh) > 0 {
				return
			}
...
func pMapActivityRouteErrNoOrder(f func(Activity) (Route, error), list []Activity, worker int) ([]Route, error) {
	chJobs := make(chan Activity, len(list))
	go func() {
		for _, v := range list {
			chJobs <- v
	...
	for i := 0; i < worker; i++ {
		...
		go func(chResult chan Route, chJobs chan Activity, errCh chan error) {
			defer wg.Done()
			if len(errCh) > 0 {
				return
			}
...
// PMapActivityRoutePtr applies the function(1st argument) on each item in the list and returns a new list.
//  Order of new list is guaranteed. This feature can be disabled by passing: Optional{RandomOrder: true} to gain performance
//  Run in parallel. no_of_goroutines = no_of_items_in_list or 3rd argument can be passed to fix the number of goroutines.
//
// Takes 3 inputs. 3rd argument is optional
...
//  2. List
//  3. optional argument - fp.Optional{FixedPool: <some_number>}
func PMapActivityRoutePtr(f func(*Activity) *Route, list []*Activity, optional ...fp.Optional) []*Route {
	if f == nil {
		return []*Route{}
	}
	...
	if optional != nil && len(optional) > 0 {
		...
		if optional[0].RandomOrder == true {
			return pMapActivityRoutePtrNoOrder(f, list, worker)
		}
	}

	return pMapActivityRoutePtrPreserveOrder(f, list, worker)
}

func pMapActivityRoutePtrPreserveOrder(f func(*Activity) *Route, list []*Activity, worker int) []*Route {
	chJobs := make(chan map[int]*Activity, len(list))
	go func() {
		for i, v := range list {
			chJobs <- map[int]*Activity{i: v}
...
func pMapActivityRoutePtrNoOrder(f func(*Activity) *Route, list []*Activity, worker int) []*Route {
	chJobs := make(chan *Activity, len(list))
	go func() {
		for _, v := range list {
			chJobs <- v
...
// PMapActivityRoutePtrErr applies the function(1st argument) on each item in the list and returns a new list and error.
//  Order of new list is guaranteed. This feature can be disabled by passing: Optional{RandomOrder: true} to gain performance
//  Run in parallel. no_of_goroutines = no_of_items_in_list or 3rd argument can be passed to fix the number of goroutines.
//
// Takes 3 inputs. 3rd argument is optional
...
//  2. List
//  3. optional argument - fp.Optional{FixedPool: <some_number>}
func PMapActivityRoutePtrErr(f func(*Activity) (*Route, error), list []*Activity, optional ...fp.Optional) ([]*Route, error) {
	if f == nil {
		return []*Route{}, nil
	}
	...
	if optional != nil && len(optional) > 0 {
		...
		if optional[0].RandomOrder == true {
			return pMapActivityRoutePtrErrNoOrder(f, list, worker)
		}
	}

	return pMapActivityRoutePtrErrPreserveOrder(f, list, worker)
}

func pMapActivityRoutePtrErrPreserveOrder(f func(*Activity) (*Route, error), list []*Activity, worker int) ([]*Route, error) {
	chJobs := make(chan map[int]*Activity, len(list))
	go func() {
		for i, v := range list {
			chJobs <- map[int]*Activity{i: v}
...
func pMapActivityRoutePtrErrNoOrder(f func(*Activity) (*Route, error), list []*Activity, worker int) ([]*Route, error) {
	chJobs := make(chan *Activity, len(list))
	go func() {
		for _, v := range list {
			chJobs <- v
...
// FilterMapActivityRoute filters given list, then apply function(2nd argument) on each item in the list and returns a new list
// Takes 3 inputs
//	1. Function: takes one input type - Activity and returns true/false.
//	2. Function: takes Activity as argument and returns Route
// 	3. List of type Activity
//
// Returns:
//	New List of type Route
//  Empty list if all there parameters are nil or either of parameter is nil
func FilterMapActivityRoute(fFilter func(Activity) bool, fMap func(Activity) Route, list []Activity) []Route {
	if fFilter == nil || fMap == nil {
		return []Route{}
	}
	var newList []Route
...
// FilterMapActivityRoutePtrErr filters given list, then apply function(2nd argument) on each item in the list and returns a new list, error
// Takes 3 inputs
//	1. Function: takes one input type - *Activity and returns (bool, error).
//	2. Function: takes *Activity as argument and returns (*Route, error)
// 	3. List of type *Activity
//
// Returns:
//	New List of type *Route, error
//  Empty list if all there parameters are nil or either of parameter is nil
func FilterMapActivityRoutePtrErr(fFilter func(*Activity) (bool, error), fMap func(*Activity) (*Route, error), list []*Activity) ([]*Route, error) {
	if fFilter == nil || fMap == nil {
		return []*Route{}, nil
	}
	var newList []*Route
...
// FilterMapActivityRouteErr filters given list, then apply function(2nd argument) on each item in the list and returns a new list, error
// Takes 3 inputs
//	1. Function: takes one input type - Activity and returns (bool, error).
//	2. Function: takes Activity as argument and returns (Route, error)
// 	3. List of type Activity
...
//	New List of type Route, error
//  Empty list if all there parameters are nil or either of parameter is nil
func FilterMapActivityRouteErr(fFilter func(Activity) (bool, error), fMap func(Activity) (Route, error), list []Activity) ([]Route, error) {
	if fFilter == nil || fMap == nil {
		return []Route{}, nil
	}
	var newList []Route
...
// MapRouteActivity takes two inputs -
// 1. Function 2. List. Then It returns a new list after applying the function on each item of the list
func MapRouteActivity(f func(Route) Activity, list []Route) []Activity {
	if f == nil {
		return []Activity{}
	}
	newList := make([]Activity, len(list))
...
// MapRouteActivityErr takes two inputs -
// 1. Function 2. List. Then It returns a new list after applying the function on each item of the list and error
func MapRouteActivityErr(f func(Route) (Activity, error), list []Route) ([]Activity, error) {
	if f == nil {
		return []Activity{}, nil
	}
	newList := make([]Activity, len(list))
...
// MapRouteActivityPtr takes two inputs -
// 1. Function 2. List. Then It returns a new list after applying the function on each item of the list
func MapRouteActivityPtr(f func(*Route) *Activity, list []*Route) []*Activity {
	if f == nil {
		return []*Activity{}
	}
	newList := make([]*Activity, len(list))
...
// MapRouteActivityPtrErr takes two inputs -
// 1. Function 2. List. Then It returns a new list after applying the function on each item of the list, error
func MapRouteActivityPtrErr(f func(*Route) (*Activity, error), list []*Route) ([]*Activity, error) {
	if f == nil {
		return []*Activity{}, nil
	}
	newList := make([]*Activity, len(list))
...
// PMapRouteActivity applies the function(1st argument) on each item in the list and returns a new list.
//  Order of new list is guaranteed. This feature can be disabled by passing: Optional{RandomOrder: true} to gain performance
//  Run in parallel. no_of_goroutines = no_of_items_in_list or 3rd argument can be passed to fix the number of goroutines.
//
// Takes 3 inputs. 3rd argument is optional
...
//  2. List
//  3. optional argument - fp.Optional{FixedPool: <some_number>}
func PMapRouteActivity(f func(Route) Activity, list []Route, optional ...fp.Optional) []Activity {
	if f == nil {
		return []Activity{}
	}
	...
	if optional != nil && len(optional) > 0 {
		...
		if optional[0].RandomOrder == true {
			return pMapRouteActivityNoOrder(f, list, worker)
		}
	}

	return pMapRouteActivityPreserveOrder(f, list, worker)
}

func pMapRouteActivityPreserveOrder(f func(Route) Activity, list []Route, worker int) []Activity {
	chJobs := make(chan map[int]Route, len(list))
	go func() {
		for i, v := range list {
			chJobs <- map[int]Route{i: v}
	...
	for i := 0; i < worker; i++ {
		...
		go func(chResult chan map[int]Activity, chJobs chan map[int]Route) {
			defer wg.Done()
...
func pMapRouteActivityNoOrder(f func(Route) Activity, list []Route, worker int) []Activity {
	chJobs := make(chan Route, len(list))
	go func() {
		for _, v := range list {
			chJobs <- v
	...
	for i := 0; i < worker; i++ {
		...
		go func(chResult chan Activity, chJobs chan Route) {
			defer wg.Done()
...
// PMapRouteActivityErr applies the function(1st argument) on each item in the list and returns a new list and error.
//  Order of new list is guaranteed. This feature can be disabled by passing: Optional{RandomOrder: true} to gain performance
//  Run in parallel. no_of_goroutines = no_of_items_in_list or 3rd argument can be passed to fix the number of goroutines.
//
// Takes 3 inputs. 3rd argument is optional
...
//  2. List
//  3. optional argument - fp.Optional{FixedPool: <some_number>}
func PMapRouteActivityErr(f func(Route) (Activity, error), list []Route, optional ...fp.Optional) ([]Activity, error) {
	if f == nil {
		return []Activity{}, nil
	}
	...
	if optional != nil && len(optional) > 0 {
		...
		if optional[0].RandomOrder == true {
			return pMapRouteActivityErrNoOrder(f, list, worker)
		}
	}

	return pMapRouteActivityErrPreserveOrder(f, list, worker)
}

func pMapRouteActivityErrPreserveOrder(f func(Route) (Activity, error), list []Route, worker int) ([]Activity, error) {
	chJobs := make(chan map[int]Route, len(list))
	go func() {
		for i, v := range list {
			chJobs <- map[int]Route{i: v}
	...
	for i := 0; i < worker; i++ {
		...
		go func(chResult chan map[int]Activity, chJobs chan map[int]Route, errCh chan error) {
			defer wg.Done()
			if len(errCh) > 0 {
				return
			}
...
func pMapRouteActivityErrNoOrder(f func(Route) (Activity, error), list []Route, worker int) ([]Activity, error) {
	chJobs := make(chan Route, len(list))
	go func() {
		for _, v := range list {
			chJobs <- v
	...
	for i := 0; i < worker; i++ {
		...
		go func(chResult chan Activity, chJobs chan Route, errCh chan error) {
			defer wg.Done()
			if len(errCh) > 0 {
				return
			}
...
// PMapRouteActivityPtr applies the function(1st argument) on each item in the list and returns a new list.
//  Order of new list is guaranteed. This feature can be disabled by passing: Optional{RandomOrder: true} to gain performance
//  Run in parallel. no_of_goroutines = no_of_items_in_list or 3rd argument can be passed to fix the number of goroutines.
//
// Takes 3 inputs. 3rd argument is optional
...
//  2. List
//  3. optional argument - fp.Optional{FixedPool: <some_number>}
func PMapRouteActivityPtr(f func(*Route) *Activity, list []*Route, optional ...fp.Optional) []*Activity {
	if f == nil {
		return []*Activity{}
	}
	...
	if optional != nil && len(optional) > 0 {
		...
		if optional[0].RandomOrder == true {
			return pMapRouteActivityPtrNoOrder(f, list, worker)
		}
	}

	return pMapRouteActivityPtrPreserveOrder(f, list, worker)
}

func pMapRouteActivityPtrPreserveOrder(f func(*Route) *Activity, list []*Route, worker int) []*Activity {
	chJobs := make(chan map[int]*Route, len(list))
	go func() {
		for i, v := range list {
			chJobs <- map[int]*Route{i: v}
...
func pMapRouteActivityPtrNoOrder(f func(*Route) *Activity, list []*Route, worker int) []*Activity {
	chJobs := make(chan *Route, len(list))
	go func() {
		for _, v := range list {
			chJobs <- v
...
// PMapRouteActivityPtrErr applies the function(1st argument) on each item in the list and returns a new list and error.
//  Order of new list is guaranteed. This feature can be disabled by passing: Optional{RandomOrder: true} to gain performance
//  Run in parallel. no_of_goroutines = no_of_items_in_list or 3rd argument can be passed to fix the number of goroutines.
//
// Takes 3 inputs. 3rd argument is optional
...
//  2. List
//  3. optional argument - fp.Optional{FixedPool: <some_number>}
func PMapRouteActivityPtrErr(f func(*Route) (*Activity, error), list []*Route, optional ...fp.Optional) ([]*Activity, error) {
	if f == nil {
		return []*Activity{}, nil
	}
	...
	if optional != nil && len(optional) > 0 {
		...
		if optional[0].RandomOrder == true {
			return pMapRouteActivityPtrErrNoOrder(f, list, worker)
		}
	}

	return pMapRouteActivityPtrErrPreserveOrder(f, list, worker)
}

func pMapRouteActivityPtrErrPreserveOrder(f func(*Route) (*Activity, error), list []*Route, worker int) ([]*Activity, error) {
	chJobs := make(chan map[int]*Route, len(list))
	go func() {
		for i, v := range list {
			chJobs <- map[int]*Route{i: v}
...
func pMapRouteActivityPtrErrNoOrder(f func(*Route) (*Activity, error), list []*Route, worker int) ([]*Activity, error) {
	chJobs := make(chan *Route, len(list))
	go func() {
		for _, v := range list {
			chJobs <- v
...
// FilterMapRouteActivity filters given list, then apply function(2nd argument) on each item in the list and returns a new list
// Takes 3 inputs
//	1. Function: takes one input type - Route and returns true/false.
//	2. Function: takes Route as argument and returns Activity
// 	3. List of type Route
//
// Returns:
//	New List of type Activity
//  Empty list if all there parameters are nil or either of parameter is nil
func FilterMapRouteActivity(fFilter func(Route) bool, fMap func(Route) Activity, list []Route) []Activity {
	if fFilter == nil || fMap == nil {
		return []Activity{}
	}
	var newList []Activity
...
// FilterMapRouteActivityPtrErr filters given list, then apply function(2nd argument) on each item in the list and returns a new list, error
// Takes 3 inputs
//	1. Function: takes one input type - *Route and returns (bool, error).
//	2. Function: takes *Route as argument and returns (*Activity, error)
// 	3. List of type *Route
//
// Returns:
//	New List of type *Activity, error
//  Empty list if all there parameters are nil or either of parameter is nil
func FilterMapRouteActivityPtrErr(fFilter func(*Route) (bool, error), fMap func(*Route) (*Activity, error), list []*Route) ([]*Activity, error) {
	if fFilter == nil || fMap == nil {
		return []*Activity{}, nil
	}
	var newList []*Activity
...
// FilterMapRouteActivityErr filters given list, then apply function(2nd argument) on each item in the list and returns a new list, error
// Takes 3 inputs
//	1. Function: takes one input type - Route and returns (bool, error).
//	2. Function: takes Route as argument and returns (Activity, error)
// 	3. List of type Route
...
//	New List of type Activity, error
//  Empty list if all there parameters are nil or either of parameter is nil
func FilterMapRouteActivityErr(fFilter func(Route) (bool, error), fMap func(Route) (Activity, error), list []Route) ([]Activity, error) {
	if fFilter == nil || fMap == nil {
		return []Activity{}, nil
	}
	var newList []Activity
...
type byDistanceRoute []Route

func (a byDistanceRoute) Len() int           { return len(a) }
func (a byDistanceRoute) Less(i, j int) bool { return a[i].Distance < a[j].Distance }
func (a byDistanceRoute) Swap(i, j int)      { a[i], a[j] = a[j], a[i] }

// SortRouteByDistance sort structs
func SortRouteByDistance(list []Route) []Route {
	if len(list) == 0 {
		return []Route{}
	}
	newList := make([]Route, len(list))
	...
	sort.Sort(byDistanceRoute(newList))
	return newList
}

// SortRouteByDistancePtr sorts structs
func SortRouteByDistancePtr(list []*Route) []*Route {
	if len(list) == 0 {
		return []*Route{}
	}
	newList := make([]Route, len(list))
	newListPtr := make([]*Route, len(list))
...
type byDistanceRouteDesc []Route

func (a byDistanceRouteDesc) Len() int           { return len(a) }
func (a byDistanceRouteDesc) Less(i, j int) bool { return a[i].Distance > a[j].Distance }
func (a byDistanceRouteDesc) Swap(i, j int)      { a[i], a[j] = a[j], a[i] }

// SortRouteByDistanceDesc sorts structs
func SortRouteByDistanceDesc(list []Route) []Route {
	if len(list) == 0 {
		return []Route{}
	}
	newList := make([]Route, len(list))
	...
	sort.Sort(byDistanceRouteDesc(newList))
	return newList
}

// SortRouteByDistanceDescPtr sorts structs
func SortRouteByDistanceDescPtr(list []*Route) []*Route {
	if len(list) == 0 {
		return []*Route{}
	}
	newList := make([]Route, len(list))
...
type byDescriptionRoute []Route

func (a byDescriptionRoute) Len() int           { return len(a) }
func (a byDescriptionRoute) Less(i, j int) bool { return a[i].Description < a[j].Description }
func (a byDescriptionRoute) Swap(i, j int)      { a[i], a[j] = a[j], a[i] }

// SortRouteByDescription sort structs
func SortRouteByDescription(list []Route) []Route {
	if len(list) == 0 {
		return []Route{}
	}
	newList := make([]Route, len(list))
	...
	sort.Sort(byDescriptionRoute(newList))
	return newList
}

// SortRouteByDescriptionPtr sorts structs
func SortRouteByDescriptionPtr(list []*Route) []*Route {
	if len(list) == 0 {
		return []*Route{}
	}
	newList := make([]Route, len(list))
...
type byDescriptionRouteDesc []Route

func (a byDescriptionRouteDesc) Len() int           { return len(a) }
func (a byDescriptionRouteDesc) Less(i, j int) bool { return a[i].Description > a[j].Description }
func (a byDescriptionRouteDesc) Swap(i, j int)      { a[i], a[j] = a[j], a[i] }

// SortRouteByDescriptionDesc sorts structs
func SortRouteByDescriptionDesc(list []Route) []Route {
	if len(list) == 0 {
		return []Route{}
	}
	newList := make([]Route, len(list))
	...
	sort.Sort(byDescriptionRouteDesc(newList))
	return newList
}

// SortRouteByDescriptionDescPtr sorts structs
func SortRouteByDescriptionDescPtr(list []*Route) []*Route {
	if len(list) == 0 {
		return []*Route{}
	}
	newList := make([]Route, len(list))
...
type byCreatedAtRoute []Route

func (a byCreatedAtRoute) Len() int           { return len(a) }
func (a byCreatedAtRoute) Less(i, j int) bool { return a[i].CreatedAt.Before(a[j].CreatedAt) }
func (a byCreatedAtRoute) Swap(i, j int)      { a[i], a[j] = a[j], a[i] }

// SortRouteByCreatedAt sort structs
func SortRouteByCreatedAt(list []Route) []Route {
	if len(list) == 0 {
		return []Route{}
	}
	newList := make([]Route, len(list))
	...
	sort.Sort(byCreatedAtRoute(newList))
	return newList
}

// SortRouteByCreatedAtPtr sorts structs
func SortRouteByCreatedAtPtr(list []*Route) []*Route {
	if len(list) == 0 {
		return []*Route{}
	}
	newList := make([]Route, len(list))
...
type byCreatedAtRouteDesc []Route

func (a byCreatedAtRouteDesc) Len() int           { return len(a) }
func (a byCreatedAtRouteDesc) Less(i, j int) bool { return a[i].CreatedAt.After(a[j].CreatedAt) }
func (a byCreatedAtRouteDesc) Swap(i, j int)      { a[i], a[j] = a[j], a[i] }

// SortRouteByCreatedAtDesc sorts structs
func SortRouteByCreatedAtDesc(list []Route) []Route {
	if len(list) == 0 {
		return []Route{}
	}
	newList := make([]Route, len(list))
	...
	sort.Sort(byCreatedAtRouteDesc(newList))
	return newList
}

// SortRouteByCreatedAtDescPtr sorts structs
func SortRouteByCreatedAtDescPtr(list []*Route) []*Route {
	if len(list) == 0 {
		return []*Route{}
	}
	newList := make([]Route, len(list))
...
type byElevationGainRoute []Route

func (a byElevationGainRoute) Len() int           { return len(a) }
func (a byElevationGainRoute) Less(i, j int) bool { return a[i].ElevationGain < a[j].ElevationGain }
func (a byElevationGainRoute) Swap(i, j int)      { a[i], a[j] = a[j], a[i] }

// SortRouteByElevationGain sort structs
func SortRouteByElevationGain(list []Route) []Route {
	if len(list) == 0 {
		return []Route{}
	}
	newList := make([]Route, len(list))
	...
	sort.Sort(byElevationGainRoute(newList))
	return newList
}

// SortRouteByElevationGainPtr sorts structs
func SortRouteByElevationGainPtr(list []*Route) []*Route {
	if len(list) == 0 {
		return []*Route{}
	}
	newList := make([]Route, len(list))
...
type byElevationGainRouteDesc []Route

func (a byElevationGainRouteDesc) Len() int           { return len(a) }
func (a byElevationGainRouteDesc) Less(i, j int) bool { return a[i].ElevationGain > a[j].ElevationGain }
func (a byElevationGainRouteDesc) Swap(i, j int)      { a[i], a[j] = a[j], a[i] }

// SortRouteByElevationGainDesc sorts structs
func SortRouteByElevationGainDesc(list []Route) []Route {
	if len(list) == 0 {
		return []Route{}
	}
	newList := make([]Route, len(list))
	...
	sort.Sort(byElevationGainRouteDesc(newList))
	return newList
}

// SortRouteByElevationGainDescPtr sorts structs
func SortRouteByElevationGainDescPtr(list []*Route) []*Route {
	if len(list) == 0 {
		return []*Route{}
	}
	newList := make([]Route, len(list))
...
type byTypeRoute []Route

func (a byTypeRoute) Len() int           { return len(a) }
func (a byTypeRoute) Less(i, j int) bool { return a[i].Type < a[j].Type }
func (a byTypeRoute) Swap(i, j int)      { a[i], a[j] = a[j], a[i] }

// SortRouteByType sort structs
func SortRouteByType(list []Route) []Route {
	if len(list) == 0 {
		return []Route{}
	}
	newList := make([]Route, len(list))
	...
	sort.Sort(byTypeRoute(newList))
	return newList
}

// SortRouteByTypePtr sorts structs
func SortRouteByTypePtr(list []*Route) []*Route {
	if len(list) == 0 {
		return []*Route{}
	}
	newList := make([]Route, len(list))
...
type byTypeRouteDesc []Route

func (a byTypeRouteDesc) Len() int           { return len(a) }
func (a byTypeRouteDesc) Less(i, j int) bool { return a[i].Type > a[j].Type }
func (a byTypeRouteDesc) Swap(i, j int)      { a[i], a[j] = a[j], a[i] }

// SortRouteByTypeDesc sorts structs
func SortRouteByTypeDesc(list []Route) []Route {
	if len(list) == 0 {
		return []Route{}
	}
	newList := make([]Route, len(list))
	...
	sort.Sort(byTypeRouteDesc(newList))
	return newList
}

// SortRouteByTypeDescPtr sorts structs
func SortRouteByTypeDescPtr(list []*Route) []*Route {
	if len(list) == 0 {
		return []*Route{}
	}
	newList := make([]Route, len(list))
...
type byEstimatedMovingTimeRoute []Route

func (a byEstimatedMovingTimeRoute) Len() int           { return len(a) }
func (a byEstimatedMovingTimeRoute) Less(i, j int) bool { return a[i].EstimatedMovingTime < a[j].EstimatedMovingTime }
func (a byEstimatedMovingTimeRoute) Swap(i, j int)      { a[i], a[j] = a[j], a[i] }

// SortRouteByEstimatedMovingTime sort structs
func SortRouteByEstimatedMovingTime(list []Route) []Route {
	if len(list) == 0 {
		return []Route{}
	}
	newList := make([]Route, len(list))
	...
	sort.Sort(byEstimatedMovingTimeRoute(newList))
	return newList
}

// SortRouteByEstimatedMovingTimePtr sorts structs
func SortRouteByEstimatedMovingTimePtr(list []*Route) []*Route {
	if len(list) == 0 {
		return []*Route{}
	}
	newList := make([]Route, len(list))
...
type byEstimatedMovingTimeRouteDesc []Route

func (a byEstimatedMovingTimeRouteDesc) Len() int           { return len(a) }
func (a byEstimatedMovingTimeRouteDesc) Less(i, j int) bool { return a[i].EstimatedMovingTime > a[j].EstimatedMovingTime }
func (a byEstimatedMovingTimeRouteDesc) Swap(i, j int)      { a[i], a[j] = a[j], a[i] }

// SortRouteByEstimatedMovingTimeDesc sorts structs
func SortRouteByEstimatedMovingTimeDesc(list []Route) []Route {
	if len(list) == 0 {
		return []Route{}
	}
	newList := make([]Route, len(list))
	...
	sort.Sort(byEstimatedMovingTimeRouteDesc(newList))
	return newList
}

// SortRouteByEstimatedMovingTimeDescPtr sorts structs
func SortRouteByEstimatedMovingTimeDescPtr(list []*Route) []*Route {
	if len(list) == 0 {
		return []*Route{}
	}
	newList := make([]Route, len(list))
...
type byUpdatedAtRoute []Route

func (a byUpdatedAtRoute) Len() int           { return len(a) }
func (a byUpdatedAtRoute) Less(i, j int) bool { return a[i].UpdatedAt.Before(a[j].UpdatedAt) }
func (a byUpdatedAtRoute) Swap(i, j int)      { a[i], a[j] = a[j], a[i] }

// SortRouteByUpdatedAt sort structs
func SortRouteByUpdatedAt(list []Route) []Route {
	if len(list) == 0 {
		return []Route{}
	}
	newList := make([]Route, len(list))
	...
	sort.Sort(byUpdatedAtRoute(newList))
	return newList
}

// SortRouteByUpdatedAtPtr sorts structs
func SortRouteByUpdatedAtPtr(list []*Route) []*Route {
	if len(list) == 0 {
		return []*Route{}
	}
	newList := make([]Route, len(list))
...
type byUpdatedAtRouteDesc []Route

func (a byUpdatedAtRouteDesc) Len() int           { return len(a) }
func (a byUpdatedAtRouteDesc) Less(i, j int) bool { return a[i].UpdatedAt.After(a[j].UpdatedAt) }
func (a byUpdatedAtRouteDesc) Swap(i, j int)      { a[i], a[j] = a[j], a[i] }

// SortRouteByUpdatedAtDesc sorts structs
func SortRouteByUpdatedAtDesc(list []Route) []Route {
	if len(list) == 0 {
		return []Route{}
	}
	newList := make([]Route, len(list))
	...
	sort.Sort(byUpdatedAtRouteDesc(newList))
	return newList
}

// SortRouteByUpdatedAtDescPtr sorts structs
func SortRouteByUpdatedAtDescPtr(list []*Route) []*Route {
	if len(list) == 0 {
		return []*Route{}
	}
	newList := make([]Route, len(list))
...
type bySubTypeRoute []Route

func (a bySubTypeRoute) Len() int           { return len(a) }
func (a bySubTypeRoute) Less(i, j int) bool { return a[i].SubType < a[j].SubType }
func (a bySubTypeRoute) Swap(i, j int)      { a[i], a[j] = a[j], a[i] }

// SortRouteBySubType sort structs
func SortRouteBySubType(list []Route) []Route {
	if len(list) == 0 {
		return []Route{}
	}
	newList := make([]Route, len(list))
	...
	sort.Sort(bySubTypeRoute(newList))
	return newList
}

// SortRouteBySubTypePtr sorts structs
func SortRouteBySubTypePtr(list []*Route) []*Route {
	if len(list) == 0 {
		return []*Route{}
	}
	newList := make([]Route, len(list))
...
type bySubTypeRouteDesc []Route

func (a bySubTypeRouteDesc) Len() int           { return len(a) }
func (a bySubTypeRouteDesc) Less(i, j int) bool { return a[i].SubType > a[j].SubType }
func (a bySubTypeRouteDesc) Swap(i, j int)      { a[i], a[j] = a[j], a[i] }

// SortRouteBySubTypeDesc sorts structs
func SortRouteBySubTypeDesc(list []Route) []Route {
	if len(list) == 0 {
		return []Route{}
	}
	newList := make([]Route, len(list))
	...
	sort.Sort(bySubTypeRouteDesc(newList))
	return newList
}

// SortRouteBySubTypeDescPtr sorts structs
func SortRouteBySubTypeDescPtr(list []*Route) []*Route {
	if len(list) == 0 {
		return []*Route{}
	}
	newList := make([]Route, len(list))
...
type byIDStrRoute []Route

func (a byIDStrRoute) Len() int           { return len(a) }
func (a byIDStrRoute) Less(i, j int) bool { return a[i].IDStr < a[j].IDStr }
func (a byIDStrRoute) Swap(i, j int)      { a[i], a[j] = a[j], a[i] }

// SortRouteByIDStr sort structs
func SortRouteByIDStr(list []Route) []Route {
	if len(list) == 0 {
		return []Route{}
	}
	newList := make([]Route, len(list))
	...
	sort.Sort(byIDStrRoute(newList))
	return newList
}

// SortRouteByIDStrPtr sorts structs
func SortRouteByIDStrPtr(list []*Route) []*Route {
	if len(list) == 0 {
		return []*Route{}
	}
	newList := make([]Route, len(list))
...
type byIDStrRouteDesc []Route

func (a byIDStrRouteDesc) Len() int           { return len(a) }
func (a byIDStrRouteDesc) Less(i, j int) bool { return a[i].IDStr > a[j].IDStr }
func (a byIDStrRouteDesc) Swap(i, j int)      { a[i], a[j] = a[j], a[i] }

// SortRouteByIDStrDesc sorts structs
func SortRouteByIDStrDesc(list []Route) []Route {
	if len(list) == 0 {
		return []Route{}
	}
	newList := make([]Route, len(list))
	...
	sort.Sort(byIDStrRouteDesc(newList))
	return newList
}

// SortRouteByIDStrDescPtr sorts structs
func SortRouteByIDStrDescPtr(list []*Route) []*Route {
	if len(list) == 0 {
		return []*Route{}
	}
	newList := make([]Route, len(list))
...
type byNameRoute []Route

func (a byNameRoute) Len() int           { return len(a) }
func (a byNameRoute) Less(i, j int) bool { return a[i].Name < a[j].Name }
func (a byNameRoute) Swap(i, j int)      { a[i], a[j] = a[j], a[i] }

// SortRouteByName sort structs
func SortRouteByName(list []Route) []Route {
	if len(list) == 0 {
		return []Route{}
	}
	newList := make([]Route, len(list))
	...
	sort.Sort(byNameRoute(newList))
	return newList
}

// SortRouteByNamePtr sorts structs
func SortRouteByNamePtr(list []*Route) []*Route {
	if len(list) == 0 {
		return []*Route{}
	}
	newList := make([]Route, len(list))
...
type byNameRouteDesc []Route

func (a byNameRouteDesc) Len() int           { return len(a) }
func (a byNameRouteDesc) Less(i, j int) bool { return a[i].Name > a[j].Name }
func (a byNameRouteDesc) Swap(i, j int)      { a[i], a[j] = a[j], a[i] }

// SortRouteByNameDesc sorts structs
func SortRouteByNameDesc(list []Route) []Route {
	if len(list) == 0 {
		return []Route{}
	}
	newList := make([]Route, len(list))
	...
	sort.Sort(byNameRouteDesc(newList))
	return newList
}

// SortRouteByNameDescPtr sorts structs
func SortRouteByNameDescPtr(list []*Route) []*Route {
	if len(list) == 0 {
		return []*Route{}
	}
	newList := make([]Route, len(list))
...
type byIDRoute []Route

func (a byIDRoute) Len() int           { return len(a) }
func (a byIDRoute) Less(i, j int) bool { return a[i].ID < a[j].ID }
func (a byIDRoute) Swap(i, j int)      { a[i], a[j] = a[j], a[i] }

// SortRouteByID sort structs
func SortRouteByID(list []Route) []Route {
	if len(list) == 0 {
		return []Route{}
	}
	newList := make([]Route, len(list))
	...
	sort.Sort(byIDRoute(newList))
	return newList
}

// SortRouteByIDPtr sorts structs
func SortRouteByIDPtr(list []*Route) []*Route {
	if len(list) == 0 {
		return []*Route{}
	}
	newList := make([]Route, len(list))
...
type byIDRouteDesc []Route

func (a byIDRouteDesc) Len() int           { return len(a) }
func (a byIDRouteDesc) Less(i, j int) bool { return a[i].ID > a[j].ID }
func (a byIDRouteDesc) Swap(i, j int)      { a[i], a[j] = a[j], a[i] }

// SortRouteByIDDesc sorts structs
func SortRouteByIDDesc(list []Route) []Route {
	if len(list) == 0 {
		return []Route{}
	}
	newList := make([]Route, len(list))
	...
	sort.Sort(byIDRouteDesc(newList))
	return newList
}

// SortRouteByIDDescPtr sorts structs
func SortRouteByIDDescPtr(list []*Route) []*Route {
	if len(list) == 0 {
		return []*Route{}
	}
	newList := make([]Route, len(list))
...
type byTimestampRoute []Route

func (a byTimestampRoute) Len() int           { return len(a) }
func (a byTimestampRoute) Less(i, j int) bool { return a[i].Timestamp < a[j].Timestamp }
func (a byTimestampRoute) Swap(i, j int)      { a[i], a[j] = a[j], a[i] }

// SortRouteByTimestamp sort structs
func SortRouteByTimestamp(list []Route) []Route {
	if len(list) == 0 {
		return []Route{}
	}
	newList := make([]Route, len(list))
	...
	sort.Sort(byTimestampRoute(newList))
	return newList
}

// SortRouteByTimestampPtr sorts structs
func SortRouteByTimestampPtr(list []*Route) []*Route {
	if len(list) == 0 {
		return []*Route{}
	}
	newList := make([]Route, len(list))
...
type byTimestampRouteDesc []Route

func (a byTimestampRouteDesc) Len() int           { return len(a) }
func (a byTimestampRouteDesc) Less(i, j int) bool { return a[i].Timestamp > a[j].Timestamp }
func (a byTimestampRouteDesc) Swap(i, j int)      { a[i], a[j] = a[j], a[i] }

// SortRouteByTimestampDesc sorts structs
func SortRouteByTimestampDesc(list []Route) []Route {
	if len(list) == 0 {
		return []Route{}
	}
	newList := make([]Route, len(list))
	...
	sort.Sort(byTimestampRouteDesc(newList))
	return newList
}

// SortRouteByTimestampDescPtr sorts structs
func SortRouteByTimestampDescPtr(list []*Route) []*Route {
	if len(list) == 0 {
		return []*Route{}
	}
	newList := make([]Route, len(list))
...
// UnionRouteByDistance return a set that is the union of the input sets
// repeated value within list parameter will be ignored
func UnionRouteByDistance(arrList ...[]Route) []Route {
	resultMap := make(map[float64]bool)
	var resultArr []Route
	for _, arr := range arrList {
		for _, v := range arr {
...
// Union<FTYPE>Ptr return a set that is the union of the input sets
// repeated value within list parameter will be ignored
func UnionRouteByDistancePtr(arrList ...[]*Route) []*Route {
	resultMap := make(map[float64]bool)
	var resultArr []*Route
	for _, arr := range arrList {
		for _, v := range arr {
...
// IntersectionRouteByDistance return a set that is the intersection of the input sets
// repeated value within list parameter will be ignored
func IntersectionRouteByDistance(arrList ...[]Route) []Route {
	if arrList == nil {
		return []Route{}
	}
...
// IntersectionRouteByDistancePtr return a set that is the intersection of the input sets
// repeated value within list parameter will be ignored
func IntersectionRouteByDistancePtr(arrList ...[]*Route) []*Route {
	if arrList == nil {
		return []*Route{}
	}
...
// DifferenceRouteByDistance returns a set that is the first set without elements of the remaining sets
// repeated value within list parameter will be ignored
func DifferenceRouteByDistance(arrList ...[]Route) []Route {
	if arrList == nil {
		return []Route{}
	}
...
// DifferenceRouteByDistancePtr returns a set that is the first set without elements of the remaining sets
// repeated value within list parameter will be ignored
func DifferenceRouteByDistancePtr(arrList ...[]*Route) []*Route {
	if arrList == nil {
		return []*Route{}
	}
...
// SubsetRouteByDistance returns true or false by checking if set1 is a subset of set2
// repeated value within list parameter will be ignored
func SubsetRouteByDistance(list1, list2 []Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SubsetRouteByDistancePtr returns true or false by checking if set1 is a subset of set2
// repeated value within list parameter will be ignored
func SubsetRouteByDistancePtr(list1, list2 []*Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SupersetRouteByDistance returns true or false by checking if set1 is a superset of set2
// repeated value within list parameter will be ignored
func SupersetRouteByDistance(list1, list2 []Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SupersetRouteByDistancePtr returns true or false by checking if set1 is a superset of set2
// repeated value within list parameter will be ignored
func SupersetRouteByDistancePtr(list1, list2 []*Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SetRouteByDistance returns a set of the distinct elements of coll.
func SetRouteByDistance(list []Route) []Route {
	if list == nil || len(list) == 0 {
		return []Route{}
	}
...
// SetRouteByDistancePtr returns a set of the distinct elements of coll.
func SetRouteByDistancePtr(list []*Route) []*Route {
	if list == nil || len(list) == 0 {
		return []*Route{}
	}
...
// UnionRouteByDescription return a set that is the union of the input sets
// repeated value within list parameter will be ignored
func UnionRouteByDescription(arrList ...[]Route) []Route {
	resultMap := make(map[string]bool)
	var resultArr []Route
	for _, arr := range arrList {
		for _, v := range arr {
...
// Union<FTYPE>Ptr return a set that is the union of the input sets
// repeated value within list parameter will be ignored
func UnionRouteByDescriptionPtr(arrList ...[]*Route) []*Route {
	resultMap := make(map[string]bool)
	var resultArr []*Route
	for _, arr := range arrList {
		for _, v := range arr {
...
// IntersectionRouteByDescription return a set that is the intersection of the input sets
// repeated value within list parameter will be ignored
func IntersectionRouteByDescription(arrList ...[]Route) []Route {
	if arrList == nil {
		return []Route{}
	}
...
// IntersectionRouteByDescriptionPtr return a set that is the intersection of the input sets
// repeated value within list parameter will be ignored
func IntersectionRouteByDescriptionPtr(arrList ...[]*Route) []*Route {
	if arrList == nil {
		return []*Route{}
	}
...
// DifferenceRouteByDescription returns a set that is the first set without elements of the remaining sets
// repeated value within list parameter will be ignored
func DifferenceRouteByDescription(arrList ...[]Route) []Route {
	if arrList == nil {
		return []Route{}
	}
...
// DifferenceRouteByDescriptionPtr returns a set that is the first set without elements of the remaining sets
// repeated value within list parameter will be ignored
func DifferenceRouteByDescriptionPtr(arrList ...[]*Route) []*Route {
	if arrList == nil {
		return []*Route{}
	}
...
// SubsetRouteByDescription returns true or false by checking if set1 is a subset of set2
// repeated value within list parameter will be ignored
func SubsetRouteByDescription(list1, list2 []Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SubsetRouteByDescriptionPtr returns true or false by checking if set1 is a subset of set2
// repeated value within list parameter will be ignored
func SubsetRouteByDescriptionPtr(list1, list2 []*Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SupersetRouteByDescription returns true or false by checking if set1 is a superset of set2
// repeated value within list parameter will be ignored
func SupersetRouteByDescription(list1, list2 []Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SupersetRouteByDescriptionPtr returns true or false by checking if set1 is a superset of set2
// repeated value within list parameter will be ignored
func SupersetRouteByDescriptionPtr(list1, list2 []*Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SetRouteByDescription returns a set of the distinct elements of coll.
func SetRouteByDescription(list []Route) []Route {
	if list == nil || len(list) == 0 {
		return []Route{}
	}
...
// SetRouteByDescriptionPtr returns a set of the distinct elements of coll.
func SetRouteByDescriptionPtr(list []*Route) []*Route {
	if list == nil || len(list) == 0 {
		return []*Route{}
	}
...
// UnionRouteByCreatedAt return a set that is the union of the input sets
// repeated value within list parameter will be ignored
func UnionRouteByCreatedAt(arrList ...[]Route) []Route {
	resultMap := make(map[time.Time]bool)
	var resultArr []Route
	for _, arr := range arrList {
		for _, v := range arr {
...
// Union<FTYPE>Ptr return a set that is the union of the input sets
// repeated value within list parameter will be ignored
func UnionRouteByCreatedAtPtr(arrList ...[]*Route) []*Route {
	resultMap := make(map[time.Time]bool)
	var resultArr []*Route
	for _, arr := range arrList {
		for _, v := range arr {
...
// IntersectionRouteByCreatedAt return a set that is the intersection of the input sets
// repeated value within list parameter will be ignored
func IntersectionRouteByCreatedAt(arrList ...[]Route) []Route {
	if arrList == nil {
		return []Route{}
	}
...
// IntersectionRouteByCreatedAtPtr return a set that is the intersection of the input sets
// repeated value within list parameter will be ignored
func IntersectionRouteByCreatedAtPtr(arrList ...[]*Route) []*Route {
	if arrList == nil {
		return []*Route{}
	}
...
// DifferenceRouteByCreatedAt returns a set that is the first set without elements of the remaining sets
// repeated value within list parameter will be ignored
func DifferenceRouteByCreatedAt(arrList ...[]Route) []Route {
	if arrList == nil {
		return []Route{}
	}
...
// DifferenceRouteByCreatedAtPtr returns a set that is the first set without elements of the remaining sets
// repeated value within list parameter will be ignored
func DifferenceRouteByCreatedAtPtr(arrList ...[]*Route) []*Route {
	if arrList == nil {
		return []*Route{}
	}
...
// SubsetRouteByCreatedAt returns true or false by checking if set1 is a subset of set2
// repeated value within list parameter will be ignored
func SubsetRouteByCreatedAt(list1, list2 []Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SubsetRouteByCreatedAtPtr returns true or false by checking if set1 is a subset of set2
// repeated value within list parameter will be ignored
func SubsetRouteByCreatedAtPtr(list1, list2 []*Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SupersetRouteByCreatedAt returns true or false by checking if set1 is a superset of set2
// repeated value within list parameter will be ignored
func SupersetRouteByCreatedAt(list1, list2 []Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SupersetRouteByCreatedAtPtr returns true or false by checking if set1 is a superset of set2
// repeated value within list parameter will be ignored
func SupersetRouteByCreatedAtPtr(list1, list2 []*Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SetRouteByCreatedAt returns a set of the distinct elements of coll.
func SetRouteByCreatedAt(list []Route) []Route {
	if list == nil || len(list) == 0 {
		return []Route{}
	}
...
// SetRouteByCreatedAtPtr returns a set of the distinct elements of coll.
func SetRouteByCreatedAtPtr(list []*Route) []*Route {
	if list == nil || len(list) == 0 {
		return []*Route{}
	}
...
// UnionRouteByElevationGain return a set that is the union of the input sets
// repeated value within list parameter will be ignored
func UnionRouteByElevationGain(arrList ...[]Route) []Route {
	resultMap := make(map[float64]bool)
	var resultArr []Route
	for _, arr := range arrList {
		for _, v := range arr {
			_, ok := resultMap[v.ElevationGain]
			if !ok {
				resultMap[v.ElevationGain] = true
				resultArr = append(resultArr, v)
			}
		}
	}
...
// Union<FTYPE>Ptr return a set that is the union of the input sets
// repeated value within list parameter will be ignored
func UnionRouteByElevationGainPtr(arrList ...[]*Route) []*Route {
	resultMap := make(map[float64]bool)
	var resultArr []*Route
	for _, arr := range arrList {
		for _, v := range arr {
...
// IntersectionRouteByElevationGain return a set that is the intersection of the input sets
// repeated value within list parameter will be ignored
func IntersectionRouteByElevationGain(arrList ...[]Route) []Route {
	if arrList == nil {
		return []Route{}
	}
	...
	if len(arrList) == 1 {
		var newList []Route
		for i := 0; i < len(arrList[0]); i++ {
			_, ok := resultMap[arrList[0][i].ElevationGain]
			if !ok {
				newList = append(newList, arrList[0][i])
				resultMap[arrList[0][i].ElevationGain] = true
			}
		}
		return newList
	}
	...
	for i := 0; i < len(arrList[0]); i++ {
		...
		for j := 1; j < len(arrList); j++ {
			for _, v := range arrList[j] {
				// compare every items in 1st array to every items in the rest of the arrays
				if arrList[0][i].ElevationGain == v.ElevationGain {
					matchCount++
					break
				}
			}
...
// IntersectionRouteByElevationGainPtr return a set that is the intersection of the input sets
// repeated value within list parameter will be ignored
func IntersectionRouteByElevationGainPtr(arrList ...[]*Route) []*Route {
	if arrList == nil {
		return []*Route{}
	}
...
// DifferenceRouteByElevationGain returns a set that is the first set without elements of the remaining sets
// repeated value within list parameter will be ignored
func DifferenceRouteByElevationGain(arrList ...[]Route) []Route {
	if arrList == nil {
		return []Route{}
	}
...
// DifferenceRouteByElevationGainPtr returns a set that is the first set without elements of the remaining sets
// repeated value within list parameter will be ignored
func DifferenceRouteByElevationGainPtr(arrList ...[]*Route) []*Route {
	if arrList == nil {
		return []*Route{}
	}
...
// SubsetRouteByElevationGain returns true or false by checking if set1 is a subset of set2
// repeated value within list parameter will be ignored
func SubsetRouteByElevationGain(list1, list2 []Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
	...
	resultMap := make(map[float64]bool)
	for i := 0; i < len(list1); i++ {
		_, ok := resultMap[list1[i].ElevationGain]
		if !ok {
			found := false
			resultMap[list1[i].ElevationGain] = true
			for j := 0; j < len(list2); j++ {
				if list1[i].ElevationGain == list2[j].ElevationGain {
					found = true
					break
				}
			}
...
// SubsetRouteByElevationGainPtr returns true or false by checking if set1 is a subset of set2
// repeated value within list parameter will be ignored
func SubsetRouteByElevationGainPtr(list1, list2 []*Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SupersetRouteByElevationGain returns true or false by checking if set1 is a superset of set2
// repeated value within list parameter will be ignored
func SupersetRouteByElevationGain(list1, list2 []Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
	...
	for i := 0; i < len(list2); i++ {
		_, ok := resultMap[list2[i].ElevationGain]
		if !ok {
			found := false
			resultMap[list2[i].ElevationGain] = true
			for j := 0; j < len(list1); j++ {
				if list2[i].ElevationGain == list1[j].ElevationGain {
					found = true
					break
				}
			}
...
// SupersetRouteByElevationGainPtr returns true or false by checking if set1 is a superset of set2
// repeated value within list parameter will be ignored
func SupersetRouteByElevationGainPtr(list1, list2 []*Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SetRouteByElevationGain returns a set of the distinct elements of coll.
func SetRouteByElevationGain(list []Route) []Route {
	if list == nil || len(list) == 0 {
		return []Route{}
	}
	...
	newList := []Route{}
	for i := 0; i < len(list); i++ {
		_, ok := resultMap[list[i].ElevationGain]
		if !ok {
			resultMap[list[i].ElevationGain] = true
			newList = append(newList, list[i])
		}
	}
	return newList
...
// SetRouteByElevationGainPtr returns a set of the distinct elements of coll.
func SetRouteByElevationGainPtr(list []*Route) []*Route {
	if list == nil || len(list) == 0 {
		return []*Route{}
	}
...
// UnionRouteByType return a set that is the union of the input sets
// repeated value within list parameter will be ignored
func UnionRouteByType(arrList ...[]Route) []Route {
	resultMap := make(map[int]bool)
	var resultArr []Route
	for _, arr := range arrList {
		for _, v := range arr {
...
// Union<FTYPE>Ptr return a set that is the union of the input sets
// repeated value within list parameter will be ignored
func UnionRouteByTypePtr(arrList ...[]*Route) []*Route {
	resultMap := make(map[int]bool)
	var resultArr []*Route
	for _, arr := range arrList {
		for _, v := range arr {
...
// IntersectionRouteByType return a set that is the intersection of the input sets
// repeated value within list parameter will be ignored
func IntersectionRouteByType(arrList ...[]Route) []Route {
	if arrList == nil {
		return []Route{}
	}
...
// IntersectionRouteByTypePtr return a set that is the intersection of the input sets
// repeated value within list parameter will be ignored
func IntersectionRouteByTypePtr(arrList ...[]*Route) []*Route {
	if arrList == nil {
		return []*Route{}
	}
...
// DifferenceRouteByType returns a set that is the first set without elements of the remaining sets
// repeated value within list parameter will be ignored
func DifferenceRouteByType(arrList ...[]Route) []Route {
	if arrList == nil {
		return []Route{}
	}
...
// DifferenceRouteByTypePtr returns a set that is the first set without elements of the remaining sets
// repeated value within list parameter will be ignored
func DifferenceRouteByTypePtr(arrList ...[]*Route) []*Route {
	if arrList == nil {
		return []*Route{}
	}
...
// SubsetRouteByType returns true or false by checking if set1 is a subset of set2
// repeated value within list parameter will be ignored
func SubsetRouteByType(list1, list2 []Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SubsetRouteByTypePtr returns true or false by checking if set1 is a subset of set2
// repeated value within list parameter will be ignored
func SubsetRouteByTypePtr(list1, list2 []*Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SupersetRouteByType returns true or false by checking if set1 is a superset of set2
// repeated value within list parameter will be ignored
func SupersetRouteByType(list1, list2 []Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SupersetRouteByTypePtr returns true or false by checking if set1 is a superset of set2
// repeated value within list parameter will be ignored
func SupersetRouteByTypePtr(list1, list2 []*Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SetRouteByType returns a set of the distinct elements of coll.
func SetRouteByType(list []Route) []Route {
	if list == nil || len(list) == 0 {
		return []Route{}
	}
...
// SetRouteByTypePtr returns a set of the distinct elements of coll.
func SetRouteByTypePtr(list []*Route) []*Route {
	if list == nil || len(list) == 0 {
		return []*Route{}
	}
...
// UnionRouteByEstimatedMovingTime return a set that is the union of the input sets
// repeated value within list parameter will be ignored
func UnionRouteByEstimatedMovingTime(arrList ...[]Route) []Route {
	resultMap := make(map[int]bool)
	var resultArr []Route
	for _, arr := range arrList {
		for _, v := range arr {
			_, ok := resultMap[v.EstimatedMovingTime]
			if !ok {
				resultMap[v.EstimatedMovingTime] = true
				resultArr = append(resultArr, v)
			}
		}
	}
...
// Union<FTYPE>Ptr return a set that is the union of the input sets
// repeated value within list parameter will be ignored
func UnionRouteByEstimatedMovingTimePtr(arrList ...[]*Route) []*Route {
	resultMap := make(map[int]bool)
	var resultArr []*Route
	for _, arr := range arrList {
		for _, v := range arr {
...
// IntersectionRouteByEstimatedMovingTime return a set that is the intersection of the input sets
// repeated value within list parameter will be ignored
func IntersectionRouteByEstimatedMovingTime(arrList ...[]Route) []Route {
	if arrList == nil {
		return []Route{}
	}
	...
	if len(arrList) == 1 {
		var newList []Route
		for i := 0; i < len(arrList[0]); i++ {
			_, ok := resultMap[arrList[0][i].EstimatedMovingTime]
			if !ok {
				newList = append(newList, arrList[0][i])
				resultMap[arrList[0][i].EstimatedMovingTime] = true
			}
		}
		return newList
	}
	...
	for i := 0; i < len(arrList[0]); i++ {
		...
		for j := 1; j < len(arrList); j++ {
			for _, v := range arrList[j] {
				// compare every items in 1st array to every items in the rest of the arrays
				if arrList[0][i].EstimatedMovingTime == v.EstimatedMovingTime {
					matchCount++
					break
				}
			}
...
// IntersectionRouteByEstimatedMovingTimePtr return a set that is the intersection of the input sets
// repeated value within list parameter will be ignored
func IntersectionRouteByEstimatedMovingTimePtr(arrList ...[]*Route) []*Route {
	if arrList == nil {
		return []*Route{}
	}
...
// DifferenceRouteByEstimatedMovingTime returns a set that is the first set without elements of the remaining sets
// repeated value within list parameter will be ignored
func DifferenceRouteByEstimatedMovingTime(arrList ...[]Route) []Route {
	if arrList == nil {
		return []Route{}
	}
...
// DifferenceRouteByEstimatedMovingTimePtr returns a set that is the first set without elements of the remaining sets
// repeated value within list parameter will be ignored
func DifferenceRouteByEstimatedMovingTimePtr(arrList ...[]*Route) []*Route {
	if arrList == nil {
		return []*Route{}
	}
...
// SubsetRouteByEstimatedMovingTime returns true or false by checking if set1 is a subset of set2
// repeated value within list parameter will be ignored
func SubsetRouteByEstimatedMovingTime(list1, list2 []Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
	...
	resultMap := make(map[int]bool)
	for i := 0; i < len(list1); i++ {
		_, ok := resultMap[list1[i].EstimatedMovingTime]
		if !ok {
			found := false
			resultMap[list1[i].EstimatedMovingTime] = true
			for j := 0; j < len(list2); j++ {
				if list1[i].EstimatedMovingTime == list2[j].EstimatedMovingTime {
					found = true
					break
				}
			}
...
// SubsetRouteByEstimatedMovingTimePtr returns true or false by checking if set1 is a subset of set2
// repeated value within list parameter will be ignored
func SubsetRouteByEstimatedMovingTimePtr(list1, list2 []*Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SupersetRouteByEstimatedMovingTime returns true or false by checking if set1 is a superset of set2
// repeated value within list parameter will be ignored
func SupersetRouteByEstimatedMovingTime(list1, list2 []Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
	...
	for i := 0; i < len(list2); i++ {
		_, ok := resultMap[list2[i].EstimatedMovingTime]
		if !ok {
			found := false
			resultMap[list2[i].EstimatedMovingTime] = true
			for j := 0; j < len(list1); j++ {
				if list2[i].EstimatedMovingTime == list1[j].EstimatedMovingTime {
					found = true
					break
				}
			}
...
// SupersetRouteByEstimatedMovingTimePtr returns true or false by checking if set1 is a superset of set2
// repeated value within list parameter will be ignored
func SupersetRouteByEstimatedMovingTimePtr(list1, list2 []*Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SetRouteByEstimatedMovingTime returns a set of the distinct elements of coll.
func SetRouteByEstimatedMovingTime(list []Route) []Route {
	if list == nil || len(list) == 0 {
		return []Route{}
	}
	...
	newList := []Route{}
	for i := 0; i < len(list); i++ {
		_, ok := resultMap[list[i].EstimatedMovingTime]
		if !ok {
			resultMap[list[i].EstimatedMovingTime] = true
			newList = append(newList, list[i])
		}
	}
	return newList
...
// SetRouteByEstimatedMovingTimePtr returns a set of the distinct elements of coll.
func SetRouteByEstimatedMovingTimePtr(list []*Route) []*Route {
	if list == nil || len(list) == 0 {
		return []*Route{}
	}
...
// UnionRouteByUpdatedAt return a set that is the union of the input sets
// repeated value within list parameter will be ignored
func UnionRouteByUpdatedAt(arrList ...[]Route) []Route {
	resultMap := make(map[time.Time]bool)
	var resultArr []Route
	for _, arr := range arrList {
		for _, v := range arr {
...
// Union<FTYPE>Ptr return a set that is the union of the input sets
// repeated value within list parameter will be ignored
func UnionRouteByUpdatedAtPtr(arrList ...[]*Route) []*Route {
	resultMap := make(map[time.Time]bool)
	var resultArr []*Route
	for _, arr := range arrList {
		for _, v := range arr {
...
// IntersectionRouteByUpdatedAt return a set that is the intersection of the input sets
// repeated value within list parameter will be ignored
func IntersectionRouteByUpdatedAt(arrList ...[]Route) []Route {
	if arrList == nil {
		return []Route{}
	}
...
// IntersectionRouteByUpdatedAtPtr return a set that is the intersection of the input sets
// repeated value within list parameter will be ignored
func IntersectionRouteByUpdatedAtPtr(arrList ...[]*Route) []*Route {
	if arrList == nil {
		return []*Route{}
	}
...
// DifferenceRouteByUpdatedAt returns a set that is the first set without elements of the remaining sets
// repeated value within list parameter will be ignored
func DifferenceRouteByUpdatedAt(arrList ...[]Route) []Route {
	if arrList == nil {
		return []Route{}
	}
...
// DifferenceRouteByUpdatedAtPtr returns a set that is the first set without elements of the remaining sets
// repeated value within list parameter will be ignored
func DifferenceRouteByUpdatedAtPtr(arrList ...[]*Route) []*Route {
	if arrList == nil {
		return []*Route{}
	}
...
// SubsetRouteByUpdatedAt returns true or false by checking if set1 is a subset of set2
// repeated value within list parameter will be ignored
func SubsetRouteByUpdatedAt(list1, list2 []Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SubsetRouteByUpdatedAtPtr returns true or false by checking if set1 is a subset of set2
// repeated value within list parameter will be ignored
func SubsetRouteByUpdatedAtPtr(list1, list2 []*Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SupersetRouteByUpdatedAt returns true or false by checking if set1 is a superset of set2
// repeated value within list parameter will be ignored
func SupersetRouteByUpdatedAt(list1, list2 []Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SupersetRouteByUpdatedAtPtr returns true or false by checking if set1 is a superset of set2
// repeated value within list parameter will be ignored
func SupersetRouteByUpdatedAtPtr(list1, list2 []*Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SetRouteByUpdatedAt returns a set of the distinct elements of coll.
func SetRouteByUpdatedAt(list []Route) []Route {
	if list == nil || len(list) == 0 {
		return []Route{}
	}
...
// SetRouteByUpdatedAtPtr returns a set of the distinct elements of coll.
func SetRouteByUpdatedAtPtr(list []*Route) []*Route {
	if list == nil || len(list) == 0 {
		return []*Route{}
	}
...
// UnionRouteBySubType return a set that is the union of the input sets
// repeated value within list parameter will be ignored
func UnionRouteBySubType(arrList ...[]Route) []Route {
	resultMap := make(map[int]bool)
	var resultArr []Route
	for _, arr := range arrList {
		for _, v := range arr {
			_, ok := resultMap[v.SubType]
			if !ok {
				resultMap[v.SubType] = true
				resultArr = append(resultArr, v)
			}
		}
	}
...
// Union<FTYPE>Ptr return a set that is the union of the input sets
// repeated value within list parameter will be ignored
func UnionRouteBySubTypePtr(arrList ...[]*Route) []*Route {
	resultMap := make(map[int]bool)
	var resultArr []*Route
	for _, arr := range arrList {
		for _, v := range arr {
...
// IntersectionRouteBySubType return a set that is the intersection of the input sets
// repeated value within list parameter will be ignored
func IntersectionRouteBySubType(arrList ...[]Route) []Route {
	if arrList == nil {
		return []Route{}
	}
	...
	if len(arrList) == 1 {
		var newList []Route
		for i := 0; i < len(arrList[0]); i++ {
			_, ok := resultMap[arrList[0][i].SubType]
			if !ok {
				newList = append(newList, arrList[0][i])
				resultMap[arrList[0][i].SubType] = true
			}
		}
		return newList
	}
	...
	for i := 0; i < len(arrList[0]); i++ {
		...
		for j := 1; j < len(arrList); j++ {
			for _, v := range arrList[j] {
				// compare every items in 1st array to every items in the rest of the arrays
				if arrList[0][i].SubType == v.SubType {
					matchCount++
					break
				}
			}
...
// IntersectionRouteBySubTypePtr return a set that is the intersection of the input sets
// repeated value within list parameter will be ignored
func IntersectionRouteBySubTypePtr(arrList ...[]*Route) []*Route {
	if arrList == nil {
		return []*Route{}
	}
...
// DifferenceRouteBySubType returns a set that is the first set without elements of the remaining sets
// repeated value within list parameter will be ignored
func DifferenceRouteBySubType(arrList ...[]Route) []Route {
	if arrList == nil {
		return []Route{}
	}
...
// DifferenceRouteBySubTypePtr returns a set that is the first set without elements of the remaining sets
// repeated value within list parameter will be ignored
func DifferenceRouteBySubTypePtr(arrList ...[]*Route) []*Route {
	if arrList == nil {
		return []*Route{}
	}
...
// SubsetRouteBySubType returns true or false by checking if set1 is a subset of set2
// repeated value within list parameter will be ignored
func SubsetRouteBySubType(list1, list2 []Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
	...
	resultMap := make(map[int]bool)
	for i := 0; i < len(list1); i++ {
		_, ok := resultMap[list1[i].SubType]
		if !ok {
			found := false
			resultMap[list1[i].SubType] = true
			for j := 0; j < len(list2); j++ {
				if list1[i].SubType == list2[j].SubType {
					found = true
					break
				}
			}
...
// SubsetRouteBySubTypePtr returns true or false by checking if set1 is a subset of set2
// repeated value within list parameter will be ignored
func SubsetRouteBySubTypePtr(list1, list2 []*Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SupersetRouteBySubType returns true or false by checking if set1 is a superset of set2
// repeated value within list parameter will be ignored
func SupersetRouteBySubType(list1, list2 []Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
	...
	for i := 0; i < len(list2); i++ {
		_, ok := resultMap[list2[i].SubType]
		if !ok {
			found := false
			resultMap[list2[i].SubType] = true
			for j := 0; j < len(list1); j++ {
				if list2[i].SubType == list1[j].SubType {
					found = true
					break
				}
			}
...
// SupersetRouteBySubTypePtr returns true or false by checking if set1 is a superset of set2
// repeated value within list parameter will be ignored
func SupersetRouteBySubTypePtr(list1, list2 []*Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SetRouteBySubType returns a set of the distinct elements of coll.
func SetRouteBySubType(list []Route) []Route {
	if list == nil || len(list) == 0 {
		return []Route{}
	}
	...
	newList := []Route{}
	for i := 0; i < len(list); i++ {
		_, ok := resultMap[list[i].SubType]
		if !ok {
			resultMap[list[i].SubType] = true
			newList = append(newList, list[i])
		}
	}
	return newList
...
// SetRouteBySubTypePtr returns a set of the distinct elements of coll.
func SetRouteBySubTypePtr(list []*Route) []*Route {
	if list == nil || len(list) == 0 {
		return []*Route{}
	}
...
// UnionRouteByIDStr return a set that is the union of the input sets
// repeated value within list parameter will be ignored
func UnionRouteByIDStr(arrList ...[]Route) []Route {
	resultMap := make(map[string]bool)
	var resultArr []Route
	for _, arr := range arrList {
		for _, v := range arr {
			_, ok := resultMap[v.IDStr]
			if !ok {
				resultMap[v.IDStr] = true
				resultArr = append(resultArr, v)
			}
		}
	}
...
// Union<FTYPE>Ptr return a set that is the union of the input sets
// repeated value within list parameter will be ignored
func UnionRouteByIDStrPtr(arrList ...[]*Route) []*Route {
	resultMap := make(map[string]bool)
	var resultArr []*Route
	for _, arr := range arrList {
		for _, v := range arr {
...
// IntersectionRouteByIDStr return a set that is the intersection of the input sets
// repeated value within list parameter will be ignored
func IntersectionRouteByIDStr(arrList ...[]Route) []Route {
	if arrList == nil {
		return []Route{}
	}
	...
	if len(arrList) == 1 {
		var newList []Route
		for i := 0; i < len(arrList[0]); i++ {
			_, ok := resultMap[arrList[0][i].IDStr]
			if !ok {
				newList = append(newList, arrList[0][i])
				resultMap[arrList[0][i].IDStr] = true
			}
		}
		return newList
	}
...
// IntersectionRouteByIDStrPtr return a set that is the intersection of the input sets
// repeated value within list parameter will be ignored
func IntersectionRouteByIDStrPtr(arrList ...[]*Route) []*Route {
	if arrList == nil {
		return []*Route{}
	}
...
// DifferenceRouteByIDStr returns a set that is the first set without elements of the remaining sets
// repeated value within list parameter will be ignored
func DifferenceRouteByIDStr(arrList ...[]Route) []Route {
	if arrList == nil {
		return []Route{}
	}
...
// DifferenceRouteByIDStrPtr returns a set that is the first set without elements of the remaining sets
// repeated value within list parameter will be ignored
func DifferenceRouteByIDStrPtr(arrList ...[]*Route) []*Route {
	if arrList == nil {
		return []*Route{}
	}
...
// SubsetRouteByIDStr returns true or false by checking if set1 is a subset of set2
// repeated value within list parameter will be ignored
func SubsetRouteByIDStr(list1, list2 []Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
	...
	resultMap := make(map[string]bool)
	for i := 0; i < len(list1); i++ {
		_, ok := resultMap[list1[i].IDStr]
		if !ok {
			found := false
			resultMap[list1[i].IDStr] = true
			for j := 0; j < len(list2); j++ {
				if list1[i].IDStr == list2[j].IDStr {
					found = true
					break
				}
			}
...
// SubsetRouteByIDStrPtr returns true or false by checking if set1 is a subset of set2
// repeated value within list parameter will be ignored
func SubsetRouteByIDStrPtr(list1, list2 []*Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SupersetRouteByIDStr returns true or false by checking if set1 is a superset of set2
// repeated value within list parameter will be ignored
func SupersetRouteByIDStr(list1, list2 []Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
	...
	for i := 0; i < len(list2); i++ {
		_, ok := resultMap[list2[i].IDStr]
		if !ok {
			found := false
			resultMap[list2[i].IDStr] = true
			for j := 0; j < len(list1); j++ {
				if list2[i].IDStr == list1[j].IDStr {
					found = true
					break
				}
			}
...
// SupersetRouteByIDStrPtr returns true or false by checking if set1 is a superset of set2
// repeated value within list parameter will be ignored
func SupersetRouteByIDStrPtr(list1, list2 []*Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SetRouteByIDStr returns a set of the distinct elements of coll.
func SetRouteByIDStr(list []Route) []Route {
	if list == nil || len(list) == 0 {
		return []Route{}
	}
	...
	newList := []Route{}
	for i := 0; i < len(list); i++ {
		_, ok := resultMap[list[i].IDStr]
		if !ok {
			resultMap[list[i].IDStr] = true
			newList = append(newList, list[i])
		}
	}
	return newList
...
// SetRouteByIDStrPtr returns a set of the distinct elements of coll.
func SetRouteByIDStrPtr(list []*Route) []*Route {
	if list == nil || len(list) == 0 {
		return []*Route{}
	}
...
// UnionRouteByName return a set that is the union of the input sets
// repeated value within list parameter will be ignored
func UnionRouteByName(arrList ...[]Route) []Route {
	resultMap := make(map[string]bool)
	var resultArr []Route
	for _, arr := range arrList {
		for _, v := range arr {
...
// Union<FTYPE>Ptr return a set that is the union of the input sets
// repeated value within list parameter will be ignored
func UnionRouteByNamePtr(arrList ...[]*Route) []*Route {
	resultMap := make(map[string]bool)
	var resultArr []*Route
	for _, arr := range arrList {
		for _, v := range arr {
...
// IntersectionRouteByName return a set that is the intersection of the input sets
// repeated value within list parameter will be ignored
func IntersectionRouteByName(arrList ...[]Route) []Route {
	if arrList == nil {
		return []Route{}
	}
...
// IntersectionRouteByNamePtr return a set that is the intersection of the input sets
// repeated value within list parameter will be ignored
func IntersectionRouteByNamePtr(arrList ...[]*Route) []*Route {
	if arrList == nil {
		return []*Route{}
	}
...
// DifferenceRouteByName returns a set that is the first set without elements of the remaining sets
// repeated value within list parameter will be ignored
func DifferenceRouteByName(arrList ...[]Route) []Route {
	if arrList == nil {
		return []Route{}
	}
...
// DifferenceRouteByNamePtr returns a set that is the first set without elements of the remaining sets
// repeated value within list parameter will be ignored
func DifferenceRouteByNamePtr(arrList ...[]*Route) []*Route {
	if arrList == nil {
		return []*Route{}
	}
...
// SubsetRouteByName returns true or false by checking if set1 is a subset of set2
// repeated value within list parameter will be ignored
func SubsetRouteByName(list1, list2 []Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SubsetRouteByNamePtr returns true or false by checking if set1 is a subset of set2
// repeated value within list parameter will be ignored
func SubsetRouteByNamePtr(list1, list2 []*Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SupersetRouteByName returns true or false by checking if set1 is a superset of set2
// repeated value within list parameter will be ignored
func SupersetRouteByName(list1, list2 []Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SupersetRouteByNamePtr returns true or false by checking if set1 is a superset of set2
// repeated value within list parameter will be ignored
func SupersetRouteByNamePtr(list1, list2 []*Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SetRouteByName returns a set of the distinct elements of coll.
func SetRouteByName(list []Route) []Route {
	if list == nil || len(list) == 0 {
		return []Route{}
	}
...
// SetRouteByNamePtr returns a set of the distinct elements of coll.
func SetRouteByNamePtr(list []*Route) []*Route {
	if list == nil || len(list) == 0 {
		return []*Route{}
	}
...
// UnionRouteByID return a set that is the union of the input sets
// repeated value within list parameter will be ignored
func UnionRouteByID(arrList ...[]Route) []Route {
	resultMap := make(map[int]bool)
	var resultArr []Route
	for _, arr := range arrList {
		for _, v := range arr {
...
// Union<FTYPE>Ptr return a set that is the union of the input sets
// repeated value within list parameter will be ignored
func UnionRouteByIDPtr(arrList ...[]*Route) []*Route {
	resultMap := make(map[int]bool)
	var resultArr []*Route
	for _, arr := range arrList {
		for _, v := range arr {
...
// IntersectionRouteByID return a set that is the intersection of the input sets
// repeated value within list parameter will be ignored
func IntersectionRouteByID(arrList ...[]Route) []Route {
	if arrList == nil {
		return []Route{}
	}
...
// IntersectionRouteByIDPtr return a set that is the intersection of the input sets
// repeated value within list parameter will be ignored
func IntersectionRouteByIDPtr(arrList ...[]*Route) []*Route {
	if arrList == nil {
		return []*Route{}
	}
...
// DifferenceRouteByID returns a set that is the first set without elements of the remaining sets
// repeated value within list parameter will be ignored
func DifferenceRouteByID(arrList ...[]Route) []Route {
	if arrList == nil {
		return []Route{}
	}
...
// DifferenceRouteByIDPtr returns a set that is the first set without elements of the remaining sets
// repeated value within list parameter will be ignored
func DifferenceRouteByIDPtr(arrList ...[]*Route) []*Route {
	if arrList == nil {
		return []*Route{}
	}
...
// SubsetRouteByID returns true or false by checking if set1 is a subset of set2
// repeated value within list parameter will be ignored
func SubsetRouteByID(list1, list2 []Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SubsetRouteByIDPtr returns true or false by checking if set1 is a subset of set2
// repeated value within list parameter will be ignored
func SubsetRouteByIDPtr(list1, list2 []*Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SupersetRouteByID returns true or false by checking if set1 is a superset of set2
// repeated value within list parameter will be ignored
func SupersetRouteByID(list1, list2 []Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SupersetRouteByIDPtr returns true or false by checking if set1 is a superset of set2
// repeated value within list parameter will be ignored
func SupersetRouteByIDPtr(list1, list2 []*Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SetRouteByID returns a set of the distinct elements of coll.
func SetRouteByID(list []Route) []Route {
	if list == nil || len(list) == 0 {
		return []Route{}
	}
...
// SetRouteByIDPtr returns a set of the distinct elements of coll.
func SetRouteByIDPtr(list []*Route) []*Route {
	if list == nil || len(list) == 0 {
		return []*Route{}
	}
...
// UnionRouteByTimestamp return a set that is the union of the input sets
// repeated value within list parameter will be ignored
func UnionRouteByTimestamp(arrList ...[]Route) []Route {
	resultMap := make(map[int]bool)
	var resultArr []Route
	for _, arr := range arrList {
		for _, v := range arr {
			_, ok := resultMap[v.Timestamp]
			if !ok {
				resultMap[v.Timestamp] = true
				resultArr = append(resultArr, v)
			}
		}
	}
...
// Union<FTYPE>Ptr return a set that is the union of the input sets
// repeated value within list parameter will be ignored
func UnionRouteByTimestampPtr(arrList ...[]*Route) []*Route {
	resultMap := make(map[int]bool)
	var resultArr []*Route
	for _, arr := range arrList {
		for _, v := range arr {
...
// IntersectionRouteByTimestamp return a set that is the intersection of the input sets
// repeated value within list parameter will be ignored
func IntersectionRouteByTimestamp(arrList ...[]Route) []Route {
	if arrList == nil {
		return []Route{}
	}
	...
	if len(arrList) == 1 {
		var newList []Route
		for i := 0; i < len(arrList[0]); i++ {
			_, ok := resultMap[arrList[0][i].Timestamp]
			if !ok {
				newList = append(newList, arrList[0][i])
				resultMap[arrList[0][i].Timestamp] = true
			}
		}
		return newList
	}
	...
	for i := 0; i < len(arrList[0]); i++ {
		...
		for j := 1; j < len(arrList); j++ {
			for _, v := range arrList[j] {
				// compare every items in 1st array to every items in the rest of the arrays
				if arrList[0][i].Timestamp == v.Timestamp {
					matchCount++
					break
				}
			}
...
// IntersectionRouteByTimestampPtr return a set that is the intersection of the input sets
// repeated value within list parameter will be ignored
func IntersectionRouteByTimestampPtr(arrList ...[]*Route) []*Route {
	if arrList == nil {
		return []*Route{}
	}
...
// DifferenceRouteByTimestamp returns a set that is the first set without elements of the remaining sets
// repeated value within list parameter will be ignored
func DifferenceRouteByTimestamp(arrList ...[]Route) []Route {
	if arrList == nil {
		return []Route{}
	}
...
// DifferenceRouteByTimestampPtr returns a set that is the first set without elements of the remaining sets
// repeated value within list parameter will be ignored
func DifferenceRouteByTimestampPtr(arrList ...[]*Route) []*Route {
	if arrList == nil {
		return []*Route{}
	}
...
// SubsetRouteByTimestamp returns true or false by checking if set1 is a subset of set2
// repeated value within list parameter will be ignored
func SubsetRouteByTimestamp(list1, list2 []Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
	...
	resultMap := make(map[int]bool)
	for i := 0; i < len(list1); i++ {
		_, ok := resultMap[list1[i].Timestamp]
		if !ok {
			found := false
			resultMap[list1[i].Timestamp] = true
			for j := 0; j < len(list2); j++ {
...
// SubsetRouteByTimestampPtr returns true or false by checking if set1 is a subset of set2
// repeated value within list parameter will be ignored
func SubsetRouteByTimestampPtr(list1, list2 []*Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SupersetRouteByTimestamp returns true or false by checking if set1 is a superset of set2
// repeated value within list parameter will be ignored
func SupersetRouteByTimestamp(list1, list2 []Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
	...
	for i := 0; i < len(list2); i++ {
		_, ok := resultMap[list2[i].Timestamp]
		if !ok {
			found := false
			resultMap[list2[i].Timestamp] = true
			for j := 0; j < len(list1); j++ {
				if list2[i].Timestamp == list1[j].Timestamp {
					found = true
					break
				}
			}
...
// SupersetRouteByTimestampPtr returns true or false by checking if set1 is a superset of set2
// repeated value within list parameter will be ignored
func SupersetRouteByTimestampPtr(list1, list2 []*Route) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SetRouteByTimestamp returns a set of the distinct elements of coll.
func SetRouteByTimestamp(list []Route) []Route {
	if list == nil || len(list) == 0 {
		return []Route{}
	}
	...
	newList := []Route{}
	for i := 0; i < len(list); i++ {
		_, ok := resultMap[list[i].Timestamp]
		if !ok {
			resultMap[list[i].Timestamp] = true
			newList = append(newList, list[i])
		}
	}
	return newList
...
// SetRouteByTimestampPtr returns a set of the distinct elements of coll.
func SetRouteByTimestampPtr(list []*Route) []*Route {
	if list == nil || len(list) == 0 {
		return []*Route{}
	}
